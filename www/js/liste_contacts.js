...
var tabDyn = function(config, callback) {
    ...
    this.delete = function(evt) {
        ...
        for (var i = 0; i < self.config.data.length; i++) {
            ...
            if (elem.checked) {
                ...
                window.location = 'liste_contacts.html'; // réfléchir pour remplacer le reload par un refresh du DOM.
            }
        }
    ...
    this.sortColumn = function(evt) {
        ...
        localStorage.setItem('contacts', JSON.stringify(self.config.data));
        window.location = 'liste_contacts.html'; // réfléchir pour remplacer le reload par un refresh du DOM sans JQuery.
    }
    ...
    this.writeModifiedContact = function(evt) {
        ...
        window.location = 'liste_contacts.html';
    }
